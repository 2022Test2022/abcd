...
ylabel('Values')
%-------------------------------------------------------------------
To find the N-point DFT of two sequences using single N-point DFT 
(use FFT algorithm to find DFT)
N_PointDFT.m
clear all;
...
%-------------------------------------------------------------------Sectioned Convolution: Overlap Save and Overlap Add Method for 
